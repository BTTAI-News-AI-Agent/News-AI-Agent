...
| Sonia Broni  |   bronisonia  | Data Exploration/Wrangling: tokenization, stop-word removal, lemmatization, established code for the data processing; Model development and evaluation: Random Forest for categorization and evaluation (hyper-parameter tuning with GridSearch), T5 research for summarization; Chatbot: golden questions set; Final Presentation: development, organization and slide deck coordination |
| Erwin Coq   |   SAMGETUB   |  |
