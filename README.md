...
| Sophie Lin  |    sophieelin |  |
| Sonia Broni  |   bronisonia  | Data Exploration/Wrangling: tokenization, stop-word removal, lemmatization, established code for the data processing, and visualization ; Model development and evaluation: Random Forest for categorization and evaluation (hyper-parameter tuning with GridSearch), T5 research for summarization; Chatbot: golden questions set; Final Presentation: development, organization and slide deck coordination ; Team Strategies: Cross-check collaboration & assistance in delegation|
| Erwin Coq   |   SAMGETUB   |  |
